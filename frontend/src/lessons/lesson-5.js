...
const Lesson5 = () => {
    ...
    const themeColors = ['#F7F73B', '#F5F59A'];
            ...
            <main class='col ps-md-2 pt-2'>
                <div class='container lesson-container' style={{ padding: '1em 2em 1em 2em' }}>
                    <div class='row'>
                        ...
                        <MultiPlayer 
                            srcs={['/assets/audio/Dialogue_5.mp3', '/assets/audio/Dialogue_5_Slow.mp3']}
                            titles={['Normal', 'Slow']}
                        />
                        ...
                        <MultiPlayer 
                            srcs={['/assets/audio/Dialogue_5-2.mp3', '/assets/audio/Dialogue_5_Slow-2.mp3']}
                            titles={['Normal', 'Slow']}
                        />
